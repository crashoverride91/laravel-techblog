            ...
            <div class="sidebar-box m-5">
              ...
              <div class="post-entry-sidebar">
                <ul>
                  ...
                  <li>
                    <a href="">
                      <img src="{{asset($post->image)}}" style="width:90px; height:90px" alt="Image placeholder" class="mr-4">
                      <div class="text">
                        <h4>{{$post->title}}</h4>
                        <div class="post-meta">
        ...
        <div class="row align-items-stretch retro-layout">
          ...
          <div class="col-md-7">
            ...
            <div class="two-col d-block d-md-flex justify-content-between">
              ...
              <a href="{{route('website.post', ['slug'=>$post->slug])}}" class="hentry v-height img-2 gradient mr-2" style="background-image: url('{{$post->image}}');">
